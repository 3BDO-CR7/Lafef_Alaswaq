          ...
          <Content>
            ...
            <View style={styles.user_info}>
                <Button style={styles.btn_click_move}>
                    <Text style={styles.btn_text_move} onPress={() => {
                        (this.props.auth) ? this.props.navigation.navigate('profile') : this.props.navigation.navigate('login');
                    }}>{ (this.props.auth) ?   I18n.translate('profile') : I18n.translate('signIn')  }</Text>
                </Button>
            </View>

          {
                    ...
                    <View style={styles.block_section_move_mune}>
                            <View style={styles.MainContainer}>
                                 ...
                                 <Switch
                                     ...
                                     trackColor={{ true: '#00374B', false: '#ddd'  }}
                                     thumbColor={['#fff']}
                                 />
                            </View>
                    </View>
            ...
            <View style={[ styles.block_section_move_mune ]}>
                 <View style={styles.blocking_move}>
                     ...
                     <Animatable.View animation="zoomInLeft" easing="ease-out" delay={400}   >
                     ...
                     <Animatable.View animation="zoomIn" easing="ease-out" delay={400}   >
                     ...
                     <Animatable.View animation="zoomInRight" easing="ease-out" delay={400}   >
...

              {
                    (this.props.auth) ?
                        ...
                        >
                            ...
                            <Icon style={[ styles.text_red, styles.textSize_20 ]} type="Feather" name='chevron-left' />
                        </TouchableOpacity>
                        :
                        <View/>
                }
            ...
            <View style={styles.block_section_move_mune}>
                ...
                <View style={styles.blocking_move}>
                    ...
                    <View style={styles.block_item_move}>
                        <TouchableOpacity  onPress={() => { Linking.openURL('http://bit.ly/2OmDCjw' ) } } >
