...
class chnage_password extends Component {
    ...
    sendData()
    {
        ...
        axios.post(`${CONST.url}edit_password`, {
            ...
            {
                Toast.show({ text: response.data.msg, duration : 2000 ,type : 'success'  ,textStyle: { color: "#FFF",fontFamily            : 'CairoRegular' ,textAlign:'center' } });
                this.props.navigation.navigate('profile');
            }else{
                Toast.show({ text: response.data.msg, duration : 2000 ,type : 'danger'  ,textStyle: { color: "#FFF",fontFamily            : 'CairoRegular' ,textAlign:'center' } });
                ...
                <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                    ...
                    <KeyboardAvoidingView behavior="padding"    style={{  flex: 1 , marginHorizontal: 40}} >
                        ...
                        <Item floatingLabel style={styles.item} >
                            ...
                            <Input  autoCapitalize='none' secureTextEntry style={styles.input}  value={this.state.password} onChangeText={(password)=> this.changeFocusPassword(password)} />
                        </Item>

                        <Item floatingLabel style={styles.item} >
                            <Icon style={styles.icon_input} active type="SimpleLineIcons" name='lock' />
                            <Label style={styles.label}>{I18n.translate('verifyNewPass')}</Label>
                            <Input  autoCapitalize='none' secureTextEntry style={styles.input}  value={this.state.cf_password} onChangeText={(cf_password)=> this.changeFocusCfPassword(cf_password)} />
                        </Item>
