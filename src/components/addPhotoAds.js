...
class AddPhotoAds extends React.Component {
    ...
    renderImage(item, i) {
        return(
            <View key={i} style={{height: 120, width: 120, overflow :'hidden', borderRadius : 5, position: 'absolute', top : 15, alignSelf : 'center'}}>
                <Image
                    style={{height: '100%', width: '100%' }}
                    source={{uri: item}}
                    key={i}
                />
                <TouchableOpacity onPress={()=> {this.delete_img(i)}} style={{position:'absolute' , right: 0 , top :0 , backgroundColor:'rgba(0,0,0,0.5)', width: '100%', height : '100%', alignItems : 'center', justifyContent : 'center' }}>
                ...
                <Content>
                    <View style={styles.upload}>
                        <View style={[ styles.position_R, styles.paddingHorizontal_20, styles.marginVertical_25 ]}>
                            ...
                            <Text style={styles.text}>{I18n.translate('image_vid')}</Text>
