                ...
                <ScrollView>
                        ...
                        <View style = {[ styles.marginVertical_5, styles.paddingHorizontal_5, styles.paddingVertical_5, styles.Width_100, styles.SelfCenter, styles.position_R]}>
                            <View style = {[ styles.Border, styles.border_gray, styles.bg_White, styles.paddingHorizontal_10, styles.paddingVertical_5 ,styles.rowFlex, styles.Width_100, styles.position_R, { zIndex : -1 } ]}>
                                <View style = {[ styles.Bank, styles.Radius_5, styles.Border, styles.opcity_gray, styles.Radius_5, styles.bg_White ]}>
                                    <Image style={[styles.Bank]} source={{ uri: this.props.navigation.state.params.bankImg }} resizeMode={'contain'}/>
                                </View>
                    ...
                    <View style={styles.sendForms}>
                        ...
                        <Form style={[ styles.Width_100, styles.paddingHorizontal_10 ]}>
                            ...
                            {/*<View style={[ styles.item, { borderColor : (this.state.nameBankStatus === 1 ? '#dc882e' : '#DDD') } ]} >*/}
                            {/*    <Input*/}
                            {/*        placeholder={ I18n.translate('transferre')}*/}
                            ...
                            {/*        value={ this.props.navigation.state.params.bankName }*/}
                            {/*        disable={true}*/}
                            {/*    />*/}
                            {/*</View>*/}

                            <View style={[ styles.item, { borderColor : (this.state.userNameStatus === 1 ? '#dc882e' : '#DDD') } ]} >
                                <Input
                            ...
                            <View style={[ styles.item, { borderColor : (this.state.numAccStatus === 1 ? '#dc882e' : '#DDD') } ]} >
                                <Input
                            ...
                            <View style={[ styles.item, { borderColor : (this.state.countNumStatus === 1 ? '#dc882e' : '#DDD') } ]} >
                                <Input
                                    placeholder={ I18n.translate('montran')}
                                    onChangeText={(countNum) => this.setState({countNum})}
                                    style={[styles.input, styles.height_50]}
                                    onBlur={() => this.unActiveInput('countNum')}
                                    onFocus={() => this.activeInput('countNum')}
                                />
                            </View>

                            <TouchableOpacity
                                onPress={() => this.commissionModal()}
                                style={[ styles.flexCenter, styles.width_150, styles.height_50, styles.Radius_5, styles.marginVertical_10 ]}
                            >
                                <Text style={[ styles.text_darkGreen, styles.textRegular, styles.textSize_16, styles.textDecoration ]}>
                                    {I18n.translate('addWe')}
                                </Text>
                            </TouchableOpacity>

                            <TouchableOpacity style={[ styles.bg_darkGreen, styles.flexCenter, styles.width_150, styles.height_50, styles.Radius_5, styles.marginVertical_10 ]} onPress={ ()=> this.sendData()} >
                                ...
                                <View style={[ styles.Width_100, styles.paddingHorizontal_10 ]}>
                                    ...
                                    <View style={[styles.Width_100, styles.marginVertical_10]}>
                                        ...
                                        <View style={[styles.Width_100, styles.marginVertical_5]}>
                                            <View style={[ styles.item, styles.height_50 ,{ borderColor : (this.state.valOneStatus === 1 ? '#dc882e' : '#DDD') } ]} >
                                                <Input
                                    ...
                                    <View style={[styles.Width_100, styles.marginVertical_10]}>
                                        ...
                                        <View style={[styles.Width_100, styles.marginVertical_5]}>
                                            <View style={[ styles.item, styles.height_50 , styles.paddingHorizontal_10 ,{ justifyContent : 'center' ,borderColor : (this.state.valTwoStatus === 1 ? '#dc882e' : '#DDD') } ]} >
                                                <Text style={[ styles.textRegular, styles.textSize_14, styles.text_gray,{writingDirection: I18nManager.isRTL ? 'rtl' : 'ltr'} ]}>
                                                    { this.state.priceNum }
                                                </Text>
                                            </View>
                                    ...
                                    <TouchableOpacity
                                        style={[ styles.bg_darkGreen, styles.width_150, styles.height_50, styles.Radius_5, styles.marginVertical_10, styles.flexCenter ]}
                                        onPress={ ()=> this.commissionModal()}
                                    >
                                        <Text style={[ styles.text_White, styles.textRegular, styles.textSize_16 ]}>
                                            {I18n.translate('sendButton')}
